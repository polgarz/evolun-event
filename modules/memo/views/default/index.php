...
<?php if (Yii::$app->user->can('manageEvents', ['event' => $event])): ?>
    <div id="memo">
        ...
        <p>
            <a href="#" v-on:click="save" class="btn btn-success" v-cloak>Mentés</a>
            <a href="#" onclick="return false;" v-if="history && history.length > 0" class="btn btn-default" data-toggle="collapse" data-target="#history" v-cloak>Korábbi verziók <i class="fa fa-angle-down"></i></a>
        </p>
...
<?php else: ?>
    <div class="text-muted"><p>Még senki nem írt beszámolót</p></div>
<?php endif ?>